        ...
        <div className={styles.Projects}>
            ...
            <div className={styles.ProjectsCardCont}>
                <div className={styles.ProjectsCard}>
                    <Image className={styles.ProjectsCardImg} src={Pomodoro} alt="cover" width="200px" height="120px"/>
                    ...
                    <Link href="https://sicko-mode-pomodoro.vercel.app">
                        <a className={styles.ProjectsCardBtn}>Go to site<Emoji symbol="🔎" label="magnifying glass"/></a>
                    </Link>
                </div>
            </div>
        </div>
